...
class AppColors {
  static const Color primary = Color(0xFF88BD41); // Example primary color
  static const Color secondary = Color(0xFF03DAC5); // Example secondary color
  static const Color accent = Color(0xFFFF5722); // Accent color
